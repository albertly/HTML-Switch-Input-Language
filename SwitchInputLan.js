...
var FarsiType = {
  ...
  farsiKey1: [
		...
		41,	40,	215,	43,	1514 /*tav*/,	45,	1509 /*zadikS*/,	47,
		...
		1662,	1513 /*shin*/,	1504 /*nun*/,	1489 /*bet*/,	1490 /*gimel*/,	1511 /*kuf*/,	1499 /*kaf*/,	1506 /*ain*/,
		1497 /*yod*/,	1503 /*nunS*/,	1495 /*het*/,	1500 /*lamed*/,	1498 /*kafS*/,	1510 /*zadik*/,	1502 /*mem*/,	1501 /*memS*/,
		1508 /*pey*/,	1590,	1512 /*reish*/,	1491 /*dalet*/,	1488 /*alef*/,	1493 /*vav*/,	1492 /*hey*/,	1589,
		1505 /*sameh*/,	1496 /*tet*/,	1494 /*zain*/,	60,	124,	62,	1617
	],
  // prettier-ignore
  farsiKey: [
		32,	33,	34,	35,	36,	37,	1548,	1711,
      ...
      if (FarsiType.Type && z.farsi) {
        ...
        try {
          ...
          if (typeof selectionStart == 'number') {
            ...
            eElement.value =
              eElement.value.substring(0, selectionStart) +
              key +
              eElement.value.substring(selectionEnd);
            setSelectionRange(
              eElement,
